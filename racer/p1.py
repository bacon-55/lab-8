...
p.mixer.music.load("C:\\Users\\7bayb\\work2\\lab8\\racer\\back_music.wav")
...
back = p.image.load("C:\\Users\\7bayb\\work2\\lab8\\racer\\fon.png")
back = p.transform.scale(back, (X,Y))

#Import images of buttons
restart = p.image.load("C:\\Users\\7bayb\\work2\\lab8\\racer\\restart.png")
qquit = p.image.load("C:\\Users\\7bayb\work2\\lab8\\racer\\quit.png")
...
class Enemy(p.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = p.image.load("C:\\Users\\7bayb\\work2\\lab8\\racer\\Enemy.png")
...
class Player(p.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = p.image.load("C:\\Users\\7bayb\\work2\\lab8\\racer\\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(p.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = p.image.load("C:\\Users\\7bayb\\work2\\lab8\\racer\\coin.png")
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(80, X-80),0)
        self.cnt = 0
...
image_of_coin = p.image.load("C:\\Users\\7bayb\\work2\\lab8\\racer\\coin.png")
...
while run:
    for i in p.event.get():
        ...
        if i.type == p.MOUSEBUTTONDOWN and game_over_state:
            ...
            p.mixer.Sound("C:\\Users\\7bayb\work2\\lab8\\racer\\mouse_click.mp3").play()
    ...
    if p.sprite.spritecollideany(P1, enemies) and not game_over_state:
        p.mixer.Sound("C:\\Users\\7bayb\\work2\\lab8\\racer\\crash.wav").play()
        time.sleep(0.5)
    ...
    if p.sprite.spritecollideany(P1, coins) and not game_over_state:
        SCORE_COINS += 1
        p.mixer.Sound("C:\\Users\\7bayb\\work2\\lab8\\racer\\collect.mp3").play()
        C1.cnt = 60
        C1.rect.top = 0
